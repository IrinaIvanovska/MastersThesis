...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 19 20:16:39 2025

@author: ivanovsi
"""

# ============================================================================
# Training Script for Standard RL using SAC (Soft Actor-Critic)
# ============================================================================
import torch
import numpy as np
import random
...
# Create Environments
# Note: SAC uses flattened state input usually, or we need to adapt the agent to take sequences (LSTM-SAC).
# For Standard SAC, we'll flatten the sequence.
...
for episode in range(NUM_EPISODES):
    ...
    # Reset
    state_seq = env.reset()
    state_flat = state_seq.flatten() # Flatten sequence for MLP SAC
    episode_reward = 0
