...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 11 17:34:52 2025
...
# This ensures Meta-RL, Standard RL, and Evaluation all use the same objective.
# ----------------------------------------
...
def compute_reward_with_action(row, action_continuous):
    ...
    This is the key function for training agents to select good actions.
