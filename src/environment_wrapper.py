...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 28 20:34:07 2025

@author: ivanovsi

CityLearn Environment Wrapper for Reinforcement Learning

Provides a gym-like interface for building control with CityLearn.
Supports episode-based training with state sequences for LSTM Q-learning.
"""
...
# CityLearn is optional - only needed for BuildingEnvWrapper
...
class SimpleBuildingEnv:
    ...
    Less realistic than CityLearn but easier to debug.
    """
    ...
    def _compute_reward(self, state, action_cont):
        ...
        Returns:
            float: Reward value
        """
        # CRITICAL FIX: Denormalize demands to absolute kW
